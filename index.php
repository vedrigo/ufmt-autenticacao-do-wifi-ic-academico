...
<div class="container-margin-login" style="flex: 1 100%">
        ...
        <div id="noticias-ic">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <button id="btn-noticia" class="btn btn-light mt-4 btn-block" onclick="carregar('noticia')">Carregar
                        Mais
                    </button>
                </div>
            </div>
    ...
    <div class="container mb-5">
        <div id="mural-ic">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <button id="btn-mural" class="btn btn-light mt-4 btn-block" onclick="carregar('mural')">Carregar
                        Mais
                    </button>
                </div>
            </div>
...
<footer class="sticky-footer bg-white" style="flex:1 100%; align-self: flex-end">
