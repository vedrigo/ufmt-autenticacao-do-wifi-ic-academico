    ...
    ?>
      <div class="container-card" style="background-color: white;">
          <figure class="card-imagem">
            <?php $vish = 'style="padding-left: 16px !important"';
            if ($noticia['imagem'] != '') : $vish = '' ?>
          ...
          <div class="card-footer">
              <button id="apagar<?php echo $noticia['id'] ?>" onclick="apagar(<?php echo $noticia['id'] ?>)"
                      class="btn btn-link">Apagar
              </button>
              <button id="aceitar<?php echo $noticia['id'] ?>" onclick="aceitar(<?php echo $noticia['id'] ?>)"
                      class="btn btn-link float-right">Aceitar
              </button>
          </div>
      </div>
